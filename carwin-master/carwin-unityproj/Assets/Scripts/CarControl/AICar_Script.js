...
function startSimulation()	{
	...
	Invoke("checkMoving", 15); // Check if the car is moving after the first 15 seconds
}
...
function OnGUI () {
	...
	if (isLearning) {
		...
		GUI.Label (Rect (Screen.width-boxWidth + 10, 220, boxWidth - 10, 20), "Steering : " + output[parseInt(NN_OUTPUT.STEERING_FORCE)]);
		GUI.Label (Rect (Screen.width-boxWidth + 10, 240, boxWidth - 10, 20), "Acceleration : " + output[parseInt(NN_OUTPUT.ACCELERATION)]);
